...
export default {
  ...
  methods: {
    ...
    goPay() {
      if (this.$route.query.itemCode) {
        this.createbill = { ownerId: this.user.id, carCode: this.carCode, companyId: this.$route.query.id, serviceType: this.itemDetail.type, couponId: this.couponId, mgrBillDetailItemList: [{ itemId: this.itemDetail.id }], contectPersonPhone: this.phone, appointmentTime: this.time, contectPersonSex: this.sex, isItem: 1 }
      }
      if (this.$route.query.setmealId) {
        this.createbill = { ownerId: this.user.id, carCode: this.carCode, companyId: this.$route.query.id, mgrBillDetailSetmealList: [{ setmealId: this.mealDetail.id }], contectPersonPhone: this.phone, appointmentTime: this.time, contectPersonSex: this.sex, isItem: 0 }
      }
