  ...
  <div>
    ...
    <div class="mTop">
      ...
      <div class="form_wrap">
        ...
        <div class="item_list">
          <ul>
            <li v-if="myBill.isItem==1" v-for="(item,index) in myBill.mgrBillDetailItemList" :key="index">
              <span class="item-price">￥{{item.itemMoney}}</span>
              <span class="item-title">{{item.itemName}}</span>
            </li>
             <li v-if="myBill.isItem==0" v-for="(item1,index) in myBill.mgrBillDetailSetmealList" :key="index">
              <span class="item-price">￥{{item1.price}}</span>
              <span class="item-title">{{item1.setmealName}}</span>
            </li>
            <li>
              <span class="item-price">￥{{myBill.discountMoney}}</span>
              <span class="item-title">乐享优惠</span>
            </li>
            <li v-if="myBill.isItem==1">
